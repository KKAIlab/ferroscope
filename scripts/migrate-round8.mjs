// Round-8 content migration: surface legacy-audited papers into the English-first layer.
//
...
import { SPECS } from "./round8-specs.mjs";
...
const SOURCE_COMMIT = "58877ab"; // HEAD at which the legacy archive was read for this rewrite
const REVIEWER = {
  id: "claude-code-round8-migration",
  name: "Claude Code round-8 content-migration pass (implementer, not an independent reviewer)",
  role: "implementer",
};
